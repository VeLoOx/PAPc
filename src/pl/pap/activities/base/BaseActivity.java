package pl.pap.activities.base;

import java.util.ArrayList;

import pl.pap.activities.ChooseRouteActivity;
import pl.pap.activities.HomeActivity;
import pl.pap.activities.PlanRouteActivity;
import pl.pap.activities.ShowRouteActivity;
import pl.pap.activities.StartNewRouteActivity;
import pl.pap.applicationClass.App;
...
public class BaseActivity extends FragmentActivity {
	...
	private void selectSlideMenuItem(int position) {
		...
		app.slideMenuPosition=position;
